...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mphotos.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".mphotos" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".mphotos")
	}
